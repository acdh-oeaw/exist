...
cd exist-docker
mvn -q -Pdocker -Ddocker.tag=$vers-java11-ShenGC -Ddocker.org=acdhch -Ddocker.username=$DOCKER_USERNAME -Ddocker.password=$DOCKER_PASSWORD docker:build docker:push